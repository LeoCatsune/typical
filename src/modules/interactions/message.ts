...
import * as chatCommands from "../../commands/message";
import { publish } from "./publish";

export default class MessageInteractionModule implements Module {
	public static id = "interactions.message";
	private commands: Map<string, MessageCtxCommand> = new Map<string, MessageCtxCommand>();
